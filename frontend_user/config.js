 ...
 * En prod   : remplacer API_BASE par l'URL publique du backend. C'est LA seule
 *             ligne à toucher au moment du déploiement Netlify.
 * ------------------------------------------------------------------------- */
(function () {
  ...
  function guessApiBase() {
    ...
    // Serveur statique séparé (make serve-user) ou Netlify.
